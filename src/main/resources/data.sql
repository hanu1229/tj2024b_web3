...
INSERT INTO member (email, password, name, create_date, update_date) VALUES
...
-- Category 테이블 (3개)
INSERT INTO category (cname, create_date, update_date) VALUES
('전자제품', NOW(), NOW()),
('도서', NOW(), NOW()),
('의류', NOW(), NOW());

-- Product 테이블 (30개)
INSERT INTO product (pname, pcontent, pprice, pview, mno, cno, create_date, update_date) VALUES
...
INSERT INTO img(pno, iname) values
(30, "default1.jpg"),
(30, "default2.jpg");